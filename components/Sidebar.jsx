      ...
      <div>
        ...
        >
          ...
          <div
            ...
            className="group relativ flex items-center justify-center hover:bg-gray-500/20 transition-all duration-300 h-9 w-9 aspect-square rounded-lg cursor-pointer"
          >
            ...
            >
              ...
              <div
                className={`w-3 h-3 absolute b-black rotate-45 ${
                  expand
